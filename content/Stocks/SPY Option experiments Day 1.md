...
description:
aliases:
  - stocks/spy-option-experiments-day-1
---
I wanted to document and see whether SPY/QQQ/SPX heatmaps would affect the decision making and return on investments for SPY 0DTE options. Because this is considered a day trade (buying & selling option contracts that expires by the end of the day), only one contract is purchased to see the % win rate / % loss rate and see if the heatmaps could make any profit against if I were to just invest in the broader S&P500.
...
**Net Gain (in %):** +46.68%
**Days:** 1
**Did the heatmap point towards the correct direction?** Yes